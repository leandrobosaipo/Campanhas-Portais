...
assert.deepEqual(buildStaticRetroSlotPlan({ ...pnmtTop, domain: config.PNMT.domain }), {
  contextSelector: "div.hidden.lg\\:block #block-8",
  groupClass: "g g-1",
  groupId: 1,
  requireUniqueVisibleAnchor: true,
}, "PNMT grupo 1 reconstrói somente no widget desktop canônico único");
assert.equal(buildStaticRetroSlotPlan({ ...pnmtTop, domain: config.PNMT.domain, slotSelector: ".g.g-1" }), null, "PNMT não autoriza o grupo 1 fora do seletor desktop configurado");
