...
- O `claim-next` da fila usa uma única escrita atômica `UPDATE ... RETURNING`; não separar leitura e claim, pois uma leitura em réplica D1 atrasada pode esconder jobs `ready_for_runner`.
