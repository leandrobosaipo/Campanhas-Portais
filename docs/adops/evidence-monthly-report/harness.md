...
- Compatibilidade: quando um ZIP antigo só existe no banco privado, o gateway público faz fallback de leitura para a API privada. O botão mantém uma URL única sem copiar ou regenerar o pacote.
